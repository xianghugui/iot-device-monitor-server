...
package com.iot.security.auth.client.jwt;

import com.iot.security.auth.client.config.ServiceAuthConfig;
import com.iot.security.auth.client.feign.ServiceAuthFeign;
import com.iot.security.auth.common.util.jwt.IJWTInfo;
import com.iot.security.auth.common.util.jwt.JWTHelper;
...
public class ServiceAuthUtil{
    private Logger log = LoggerFactory.getLogger(ServiceAuthUtil.class);
    @Autowired
